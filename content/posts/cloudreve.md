...
- 项目地址：<a href="https://github.com/cloudreve/Cloudreve" target="_blank">Github 项目地址</a>

你可以在 <a href="https://github.com/cloudreve/Cloudreve/releases" target="_blank">GitHub Release</a> 页面获取已经构建打包完成的主程序。其中每个版本都提供了常见系统架构下可用的主程序，命名规则为cloudreve_版本号_操作系统_CPU架构.tar.gz 。比如，普通 64 位 Linux 系统上部署 3.0.0 版本，则应该下载cloudreve_3.0.0_linux_amd64.tar.gz。
